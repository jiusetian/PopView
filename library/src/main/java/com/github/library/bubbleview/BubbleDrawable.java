...
public class BubbleDrawable extends Drawable {
    ...
    //shader是渲染器的意思
    private BitmapShader mBitmapShader; //BitmapShader的作用就是通过Paint对画布进行置顶Bitmap的填充
    ...
    private Bitmap bubbleBitmap;//气泡的btm
    ...
    private void setUp(Canvas canvas) {
        switch (bubbleType) {
            ...
            case BITMAP:
                ...
                //为画笔Paint设置shader,这样就可以绘制出多彩的图形
    ...
    //让气泡btm伸缩适应rect，还有移动位置
    private void setUpShaderMatrix() {
        //通过matrix来控制气泡的拉伸和平移效果
